    ...
    <div class="container">
        <div class="section-header">
            <div class="section-header__body">
                <h2 class="section-header__title">Productos Nuevos</h2>
                            ...
                            <div class="product-card__image">
                                <div class="image image--type--product">
                                    <a href="product" class="image__body"><img class="image__tag"
                                            src="assets/images/products/product-1-245x245.png" alt="" /></a>
                                </div>
                            </div>
                            <div class="product-card__info">
                                <div class="product-card__name">
                                    <div>
                                        <a href="product">Nombre Producto</a>
                                    </div>
                                </div>
                            ...
                            <div class="product-card__image">
                                <div class="image image--type--product">
                                    <a href="product-full.html" class="image__body"><img class="image__tag"
                                            src="assets/images/products/product-2-245x245.png" alt="" /></a>
                                </div>
                            </div>
                            <div class="product-card__info">
                                <div class="product-card__name">
