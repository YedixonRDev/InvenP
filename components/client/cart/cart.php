            ...
            <div class="cart">
                <div class="cart__table cart-table">
                    <table class="cart-table__table">
                        ...
                        <tbody class="cart-table__body" id="cartListProducts"></tbody>
                                ...
                                <td colspan="6">
                                    <div class="cart-table__actions">
                                        ...
                                        <div class="cart-table__update-button">
                                            <a class="btn btn-sm btn-primary" href="productos">Ver más Productos</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                        ...
                        <div class="card-body card-body--padding--2">
                            ...
                            <table class="cart__totals-table">
                                ...
                                <tfoot>
                                    <tr>
                                        <th>Total</th>
                                        <td id="cartTotal">$00.00</td>
                                    </tr>
                                </tfoot>
                            </table>
                            <a class="btn btn-primary btn-xl btn-block" href="pago">Completar Compra</a>
                        </div>
                    </div>
                </div>
            </div>
